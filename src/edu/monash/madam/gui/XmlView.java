...
/**
 * View that syntax-highlights XML.
 * Based on code found at http://boplicity.nl/confluence/display/Java/Xml+syntax+highlighting+in+Swing+JTextPane,
 * plus an additional tweak from http://stackoverflow.com/questions/4109323/colored-xml-display-in-swing to
 * enable it to cope with non-lowercased element names.
 * 
 * TODO: allow user-selectable font and colour choices.
 * @author Robyn
 *
 */
