...
/**
 * Helper class to deal with ccp. This class was developed by Michael Simons
 * based on an original implementation by Scott Violet.
 * 
...
public final class CutCopyPasteHelper {
	...
	private static abstract class FocusedAction extends AbstractAction {
		...
		protected void update(Component permanentFocusOwner) {
			this.focusedComponent = (permanentFocusOwner instanceof JComponent) ? (JComponent) permanentFocusOwner
					: null;
			this.checkTarget();
		}
	...
	private static final class CopyAction extends FocusedAction {
		...
		public CopyAction() {
			...
			super.putValue(ACTION_COMMAND_KEY,
					"a6f9f030-c408-4531-857f-dd3aad7b43f6");
			super.putValue(ACCELERATOR_KEY, KeyStroke.getKeyStroke(
					KeyEvent.VK_C, InputEvent.CTRL_DOWN_MASK));
		}

		@Override
		public void actionPerformed(ActionEvent e) {
			export(SIRTreeTransferHandler.COPY, focusedComponent);
		}

		@Override
		public void checkTarget() {
			super.setEnabled(focusedComponent != null
					&& focusedComponent.getTransferHandler() != null
					&& actionSupported(focusedComponent.getTransferHandler()
							.getSourceActions(focusedComponent),
							SIRTreeTransferHandler.COPY));
		}
	}
	...
	private static final class CutAction extends FocusedAction {
		...
		public CutAction() {
			...
			super.setEnabled(false);
			super.putValue(ACTION_COMMAND_KEY,
					"aa33f95a-c741-407a-a0ca-0c3aedd33c4d");
			super.putValue(ACCELERATOR_KEY, KeyStroke.getKeyStroke(
		...
		@Override
		public void actionPerformed(ActionEvent e) {
			export(SIRTreeTransferHandler.MOVE, focusedComponent);
		}
	...
	private static final class PasteAction extends FocusedAction {
		...
		public PasteAction() {
			...
			super.setEnabled(false);
			super.putValue(ACTION_COMMAND_KEY,
					"2676413d-8b9e-4d64-b59a-800db6747d80");
			super.putValue(ACCELERATOR_KEY, KeyStroke.getKeyStroke(
		...
		public void checkTarget() {
			super.setEnabled(focusedComponent != null
					&& focusedComponent.getTransferHandler() != null
					&& focusedComponent.getTransferHandler().canImport(
							focusedComponent,
							getClipboard().getAvailableDataFlavors()));
		}
		...
		public void actionPerformed(ActionEvent e) {
			...
			if (target != null) {
				...
				th.importData(new TransferHandler.TransferSupport(target,
